...
define ( 'MODULEID', 120104);
$O_Session = '';
require_once RELATIVITY_PATH . 'include/it_include.inc.php';
require_once RELATIVITY_PATH . 'head.php';
$s_fun='MeetResultTable';
$s_item='StudentId';
$s_page=1;
$s_sort='A';
$s_key='';
...
?>
                    ...
                    <div class="panel panel-default sss_sub_table">
                        <div class="panel-heading">
                            <div class="caption">入园互动结果列表</div>
                            <div class="row">
								  <div class="col-lg-6">
								    <div class="input-group" style="width:300px;" >
								      <input id="Vcl_KeyMeetResult" type="text" class="form-control" placeholder="幼儿编号/姓名/证件号" value="<?php echo($s_key)?>">
								      <span class="input-group-btn">
								        <button class="btn btn-primary" type="button" onclick="search_for_meet_result()"><span  class="glyphicon glyphicon-search"></span></button>
								      </span>
								    </div>
								  </div>
								</div>
