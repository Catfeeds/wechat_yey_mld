...
if ($b_ticket)
{
    ...
    <div class="weui-msg">
        ...
        <div class="weui-msg__text-area">
            <h2 class="weui-msg__title">信息核验入场通过<br/>
		...
		echo($o_reminder->getKeyword4(0));
            ...
            <p class="weui-msg__desc">您好，请入场进行信息核验</p>
        </div>
    </div>
    ...
    <div class="weui-msg">
        ...
        <div class="weui-msg__text-area">
            <h2 class="weui-msg__title">没有信息核验入场资格</h2>
            <p class="weui-msg__desc">对不起，您没有信息核验入场资格</p>
        </div>
    </div>
    <div style="padding:15px;">
		<a class="weui-btn weui-btn_primary" onclick="document.addEventListener('WeixinJSBridgeReady', WeixinJSBridge.call('closeWindow'));">确定</a>
