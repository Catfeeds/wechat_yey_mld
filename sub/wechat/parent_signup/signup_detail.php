	    ...
	    <div id="h_info">
		    ...
		    <div class="weui-cells" style="margin-top:0px;">
		    	<div class="weui-cell">
		        	...
		        	<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label" style="width:170px;">户主与幼儿关系</label></div>
						<div class="weui-cell__bd">
			                <select class="weui-select" id="Vcl_HGuanxi" name="Vcl_HGuanxi" onchange="change_h_guanxi(this)">
		        	...
		        	<div class="weui-cell" id="h_is_yizhi" style="display: none">
		        	...
		        	<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label" style="width:170px;">幼儿落户时间</label></div>
						<div class="weui-cell__bd">
							<input name="Vcl_HInTime" id="Vcl_HInTime" class="weui-input" type="date" value=""/>
			            </div>
		        	</div>
	        		<div class="weui-cell">
		...
		<div class="weui-cells" style="margin-top:0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
	                 <input class="weui-input" id="Vcl_SignupPhone" name="Vcl_SignupPhone" type="number" pattern="[0-9]*" placeholder="必填">
	            </div>
            </div>
            <div class="weui-cell">
				<div class="weui-cell__hd"><label class="weui-label">备用联系电话</label></div>
				<div class="weui-cell__bd">
	                 <input class="weui-input" id="Vcl_SignupPhoneBackup" name="Vcl_SignupPhoneBackup" placeholder="必填">
	            </div>
            </div>
		</div>
