...
?>   
	    ...
	    {
	    	echo "<script>location.href='teaching_sport_time_start.php?item_id=".$_GET['item_id']."=&class_id=".$a_class_id[0]."'</script>"; 
	    	exit(0);
	    }
	    ?>
<?php 
...
<div class="page">
    <div class="page__bd">
		...
		for($i=0;$i<$o_table->getAllCount();$i++)
		{
			...
			echo('
				<div class="weui-cell weui-cell_access" onclick="location=\'teaching_sport_time_start.php?class_id='.$o_table->getClassId($i).'&item_id='.$_GET['item_id'].'\'">
