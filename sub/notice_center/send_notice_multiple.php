...
?>
					<div class="panel panel-default sss_sub_table">
                        ...
                        <div class="caption">
                        	<span  class="glyphicon glyphicon-plus"></span>&nbsp;群发通知
                            </div>
                            </div>
                    </div>
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
                    	...
                    	<div class="sss_form">
	                     	<div class="item">
	                     		...
	                     		<input name="Vcl_First" maxlength="50" id="Vcl_First" type="text" style="width:100%" placeholder="必填" class="form-control"/>
	                     	</div>
	                     	<div class="item">
							...
							width:100% !important;
	                     	...
	                     	<div class="item">
								...
								<button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" onclick="send_notice_multiple()">发送</button>
							</div>                   	
                     	</div>
                     </form>
