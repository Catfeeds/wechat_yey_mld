...
?>
                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
						...
						<input type="hidden" name="Vcl_FunName" value="TeacherSendNoticeSingle"/>
                    	...
                    	<div class="sss_form">
	                     	...
	                     	<div class="item">
	                     		...
	                     		$o_stu=new View_User_List($_GET['id']);
	                     		echo($o_stu->getName());
	                     		?>"/>                     		
	                     	</div>
	                     	<div class="item">
							...
							width:100% !important;
	                     	...
	                     	<div class="item">
								...
								<button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" onclick="teacher_send_notice_single()"><span class="glyphicon fa fa-send"></span>&nbsp;发送</button>
							</div>                   	
                     	</div>
                     </form>
