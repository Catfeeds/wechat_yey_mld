                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame" enctype="multipart/form-data">
                    	...
                    	<div class="sss_form">
	                     	...
	                     	<div class="item">
								...
								<button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" onclick="news_add_submit()">暂存</button>
							</div>                   	
                     	</div>
                     </form>
