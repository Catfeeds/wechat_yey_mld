...
.main_role{
	padding-right:25px;
                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
						...
						<input type="hidden" name="Vcl_FunName" value="H5Release"/>
                    	...
                    	<div class="sss_form">
	                     	...
	                     	<div class="item">
								...
								<button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" onclick="h5_release()">发布</button>
							</div>                   	
                     	</div>
                     </form>
