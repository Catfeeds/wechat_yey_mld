                    ...
                    <div class="panel panel-default sss_sub_table">
                        <div class="panel-heading" style="overflow:inherit;height:43px;">
                            ...
                            <div class="row">
								...
								{
									?>
									<button id="user_add_btn" type="button" title="添加班级" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" data-toggle="tooltip" onclick="location='ye_modify.php'">
