...
{
	echo("<script>location='audit.php'</script>");
	exit(0);
}
?>
<style>
...
-->
                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
                    	...
                    	<div class="sss_form">
                    		...
                    		?>    
                    		<div class="item" style="width:98%;height:auto;margin-top:15px;font-size:14px;color:#C9302C"><label>不批准原因（当点击“不通过”按钮时，此项必填）</label></div>
							<div class="item" style="width:48%">
								<input name="Vcl_RejectReason" id="Vcl_RejectReason" type="text" style="width: 100%" class="form-control" placeholder="当点击“不通过”按钮时，此项必填">
							</div>           	     	
...
$('#Vcl_RejectReason').removeAttr('disabled');
