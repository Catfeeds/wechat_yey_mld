...
if($o_table->getTitle()==null || $o_table->getTitle()=='' || $o_table->getState()!='2')
{
	echo("<script>location='parent_survey_manage.php'</script>");
	exit(0);
}
$s_fun='TeacherSurveyManageAnswered';
$s_item='Date';
$s_page=1;
$s_sort='D';
$s_key=$_GET['id'];
                            ...
                            <div class="row">
								  <div class="col-lg-6">
								    <div class="input-group">
								      <input id="Vcl_KeyTeacherSurveyManageAnswered" type="text" class="form-control" placeholder="教师姓名" value="<?php echo($s_otherkey)?>">
								      <span class="input-group-btn">
								        <button class="btn btn-primary" type="button" onclick="search_for_teacher_survey_manage_answered()"><span  class="glyphicon glyphicon-search"></span></button>
								      </span>
								    </div>
								  </div>
								</div>
