...
$s_fun='TeacherSurveyManageQuestion';
$s_item='Number';
$s_page=1;
$s_sort='A';
$s_key=$_GET['id'];
                    ...
                    <div class="panel panel-default sss_sub_table">
                        <div class="panel-heading" style="position:static;">
                            ...
                            <button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;
                                ...
                                <button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none;margin-left:10px;" onclick="location='teacher_survey_manage_question_modify.php?id=<?php echo($_GET['id'])?>'">
