	...
	background-color: #c9302c;
					...
					<div class="panel panel-default sss_sub_table">
                        ...
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 
                            <?php
                            $s_funname='TeacherSurveyManageQuestionAdd'; 
                            if($_GET['questionid']>0)
                            {
                            	$o_table=new Survey_Teacher_Questions($_GET['questionid']);
                            	$o_parent=new Survey_Teacher($o_table->getSurveyId());
                            	$s_funname='TeacherSurveyManageQuestionModify'; 
                            	echo('修改题目');
                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
                    	...
                    	<div class="sss_form">
							...
							<button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" onclick="teacher_survey_manage_question_modify()"><?php echo(Text::Key('Submit'))?></button>
							</div>
                     	</div>
                     </form>
