...
$o_table=new Survey_Teacher_Questions($_GET['id']);
if($o_table->getQuestion()==null || $o_table->getQuestion()=='')
{
	echo("<script>location='teacher_survey_manage.php'</script>");
	exit(0);
}
$s_fun='TeacherSurveyManageSummaryDetail';
$s_item='Name';
$s_page=1;
$s_sort='A';
$s_key=$_GET['id'];
...
?>
                    <div class="panel panel-default sss_sub_table">
                        <div class="panel-heading" style="position:static;">
                            <div class="caption" id="table_title" title="<?php echo($o_table->getQuestion())?>" style="max-width:500px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;">问题：<?php echo($o_table->getNumber().'. '.$o_table->getQuestion())?></div>
