...
$s_fun='TeacherSurveyManageSummary';
$s_item='Number';
$s_page=1;
$s_sort='A';
$s_key=$_GET['id'];
                    ...
                    <div class="panel panel-default sss_sub_table">
                        <div class="panel-heading" style="position:static;">
                            ...
                            <button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;
                                ...
                                <button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;
                                margin-top: 0px; outline: medium none;margin-left:10px;" onclick="window.open('teacher_survey_manage_summary_pdf.php?id=<?php echo($o_table->getId())?>','_blank')">
