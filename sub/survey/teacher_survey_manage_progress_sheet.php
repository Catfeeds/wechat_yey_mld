	...
	margin-left:-6px;
					...
					<div class="panel panel-default sss_sub_table">
                        <div class="panel-heading" style="position:static;">
                            <div class="caption" id="table_title">查看问卷：<?php echo($o_answer->getName())?></div>
                            ...
                            <button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;
                                ...
                                <button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;
                                margin-top: 0px; outline: medium none;margin-left:10px;" onclick="window.open('teacher_survey_manage_progress_pdf.php?id=<?php echo($o_answer->getId())?>','_blank')">
				...
				echo($o_bn_base->AilterTextArea($o_survey->getComment()))?>
						...
						<button id="user_add_btn" type="button" class="btn btn-primary cancel" aria-hidden="true" style="float: right;outline: medium none;margin-right:10px;" data-placement="left" onclick="window.open('teacher_survey_manage_progress_pdf.php?id=<?php echo($o_answer->getId())?>','_blank')"><span class="glyphicon glyphicon-print"></span>&nbsp;打印</button>
					</div>
