...
$s_fun='TeacherSurveyManageProgress';
$s_item='Name';
$s_page=1;
$s_sort='A';
$s_key=$_GET['id'];
                            ...
                            <div class="row">
								  <div class="col-lg-6">
								    <div class="input-group" style="width:200px;" >
								      <input id="Vcl_KeyTeacherSurveyManageProgress" type="text" class="form-control" placeholder="教师姓名" value="<?php echo($s_otherkey)?>">
								      <span class="input-group-btn">
								        <button class="btn btn-primary" type="button" onclick="search_for_teacher_survey_manage_progress()"><span  class="glyphicon glyphicon-search"></span></button>
								      </span>
								    </div>
								  </div>
								</div>
                            <button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;
                                margin-top: 0px; outline: medium none;margin-left:10px;" onclick="location='teacher_survey_manage.php'">
                                <?php echo(Text::Key('Back'))?></button>
                                <button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none;margin-left:10px;" onclick="teacher_survey_manage_remember(<?php echo($_GET['id'])?>)">
...
teacher_survey_manage_get_progress(<?php echo($s_key)?>)
</script>
<?php
