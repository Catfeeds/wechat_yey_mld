                            ...
                            <div class="row">
								  <div class="col-lg-6">
								    <div class="input-group">
								      <input id="Vcl_KeyAppraiseManageResult" type="text" class="form-control" placeholder="班级名称" value="<?php echo($s_otherkey)?>">
								      <span class="input-group-btn">
								        <button class="btn btn-primary" type="button" onclick="search_for_appraise_manage_result()"><span  class="glyphicon glyphicon-search"></span></button>
								      </span>
								    </div>
								  </div>
								</div>
