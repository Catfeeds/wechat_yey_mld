...
?>
					<div class="panel panel-default sss_sub_table">
                        ...
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 
                            <?php
                            $s_funname='TeacherSurveyManageAdd'; 
                            if($_GET[id]>0)
                            {
                            	$o_table=new Survey_Teacher($_GET['id']);
                            	$s_funname='TeacherSurveyManageModify'; 
                            	echo('修改问卷');
                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
                    	...
                    	<div class="sss_form">
	                     	...
	                     	<div class="item">
	                     		<label>是否匿名：</label><br/>
	                     		<select name="Vcl_IsAnonymity" id="Vcl_IsAnonymity" class="selectpicker" data-style="btn-default">
							...
							<button id="user_add_btn" type="button" class="btn btn-success" aria-hidden="true" style="float: right;outline: medium none" data-placement="left" onclick="teacher_survey_manage_modify()"><?php echo(Text::Key('Submit'))?></button>
							</div>
                     	</div>
                     </form>
...
$('#Vcl_IsAnonymity').val('<?php echo($o_table->getIsAnonymity())?>');
<?php 
}
?>
</script>
