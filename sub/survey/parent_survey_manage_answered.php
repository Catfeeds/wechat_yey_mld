...
$s_fun='ParentSurveyManageAnswered';
$s_item='ClassName';
$s_page=1;
$s_sort='A';
$s_key=$_GET['id'];
                            ...
                            <div class="row">
								  <div class="col-lg-6">
								    <div class="input-group">
								      <input id="Vcl_KeyParentSurveyManageAnswered" type="text" class="form-control" placeholder="幼儿姓名/证件号" value="<?php echo($s_otherkey)?>">
								      <span class="input-group-btn">
								        <button class="btn btn-primary" type="button" onclick="search_for_parent_survey_manage_answered()"><span  class="glyphicon glyphicon-search"></span></button>
								      </span>
								    </div>
								  </div>
								</div>
