                    ...
                    <form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
                    	...
                    	<div class="sss_form">
	                     	...
	                     	<div class="item">
	                     		...
	                     		<input name="Vcl_XiaoSum" maxlength="50" id="Vcl_XiaoSum" type="text" style="width:100%" onkeyup="value=value.replace(/[^0-9]/g,'')" placeholder="必填" class="form-control"/>
	                     	</div>  
	                     	<div class="item">
	                     		<label><span class="must">*</span> 中班招生人数：</label>
	                     		<input name="Vcl_ZhongSum" maxlength="50" id="Vcl_ZhongSum" type="text" style="width:100%" onkeyup="value=value.replace(/[^0-9]/g,'')" placeholder="必填" class="form-control"/>
	                     	</div>  
	                     	<div class="item">
	                     		<label><span class="must">*</span> 大班招生人数：</label>
	                     		<input name="Vcl_DaSum" maxlength="50" id="Vcl_DaSum" type="text" style="width:100%" onkeyup="value=value.replace(/[^0-9]/g,'')" placeholder="必填" class="form-control"/>
	                     	</div>  
	                     	<div class="item">
	                     		<label><span class="must">*</span> 半日班招生人数：</label>
	                     		<input name="Vcl_BanriSum" maxlength="50" id="Vcl_BanriSum" type="text" style="width:100%" onkeyup="value=value.replace(/[^0-9]/g,'')" placeholder="必填" class="form-control"/>
	                     	</div>  
	                     	<div class="item">
	                     		<label><span class="must">*</span> 开始报名日期：</label>
		                     		<div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input2">
                    					<input class="form-control" size="16" type="text" id="Vcl_SignupStart" name="Vcl_SignupStart" style="background-color:white">
	                     	...
	                     	<div class="item">
	                     		<label><span class="must">*</span> 报名截至日期：</label>
		                     		<div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input2">
                    					<input class="form-control" size="16" type="text" id="Vcl_SignupEnd" name="Vcl_SignupEnd" style="background-color:white">
										<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                					</div>
	                     	</div>
	                     	<div class="item">
	                     	...
	                     	<div class="item">
	                     		...
	                     		<input name="Vcl_AuditTime" maxlength="50" id="Vcl_AuditTime" type="text" style="width:100%" placeholder="必填" class="form-control"/>
	                     	</div> 
	                     	<div class="item">
	                     	...
	                     	<div class="item">
	                     		...
	                     		<input name="Vcl_HealthTime" maxlength="50" id="Vcl_HealthTime" type="text" style="width:100%" placeholder="必填" class="form-control"/>
	                     	</div> 
	                     	<div class="item">
	                     		<label><span class="must">*</span> 体检地点：</label>
	                     		<input name="Vcl_HealthAddress" maxlength="50" id="Vcl_HealthAddress" type="text" style="width:100%" placeholder="必填" class="form-control"/>
	                     	</div>   
	                     	<div class="item">
