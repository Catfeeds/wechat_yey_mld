...
?>
                    ...
                    <div class="panel panel-default sss_sub_table">
                        <div class="panel-heading">
                            <div class="caption">报名列表（核验不通过，未允许体检）</div>
                            	<div class="row">
								  <div class="col-lg-6">
								...
								<button id="user_add_btn" type="button" class="btn btn-primary" aria-hidden="true" style="float: right;outline: medium none;margin-left:10px;" onclick="output(4)">
